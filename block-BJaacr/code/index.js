...
for (let i = 0; i < got.houses[0].people.length; i++){
  ...
  console.log(`I am ${got.houses[0].people[i].name} and my description is ${got.houses[0].people[i].description}`);
}
...
for (let i = 0; i < got.houses[1].people.length; i++){
  ...
  console.log(`I am ${got.houses[1].people[i].name} and my description is ${got.houses[1].people[i].description}`);
}
